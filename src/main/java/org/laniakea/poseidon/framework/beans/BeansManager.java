package org.laniakea.poseidon.framework.beans;

import org.laniakea.poseidon.customize.ConnectionPool;
import org.laniakea.poseidon.framework.annotation.Resource;
import org.laniakea.poseidon.framework.annotation.Valid;
import org.laniakea.poseidon.framework.cache.CacheRefreshTimer;
import org.laniakea.poseidon.framework.cache.PoseidonCache;
import org.laniakea.poseidon.framework.db.JdbcSupport;
import org.laniakea.poseidon.framework.db.NativeResult;
import org.laniakea.poseidon.framework.cache.PoseidonCacheImpl;
import org.laniakea.poseidon.framework.exception.BeansManagerException;
...
import org.laniakea.poseidon.framework.db.*;
...
public class BeansManager {
    ...
    private ConnectionPool newConnectionPool() {
        return new org.laniakea.poseidon.framework.pool.ConnectionPool();
    }
