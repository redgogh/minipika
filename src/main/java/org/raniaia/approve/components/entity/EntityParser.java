package org.raniaia.approve.components.entity;
...
import org.raniaia.approve.framework.provide.entity.*;
...
public interface EntityParser {
     ...
     */
    default Map<String, String> parseEntityAnnotation(Class<?> target, Metadata metadata) throws ApproveException {
        String tableName;
        ...
        if (SecurityManager.existEntity(target)) {
            ...
            if (StringUtils.isEmpty(tableName)) {
                throw new ApproveException("@Entity value cannot null");
            }
