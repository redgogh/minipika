package org.raniaia.approve.components.pool;
 ...
 */
@Component
public class ApproveClassPool extends ClassPool {

    public ApproveClassPool() {
        this(true);
    }

    public ApproveClassPool(boolean useDefaultPath) {
        super(useDefaultPath);
    }

    public ApproveClassPool(ClassPool parent) {
        super(parent);
    }
