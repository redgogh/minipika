...
public class PoseidonProvideConstant {
    ...
    public static final String sqlAppendProcess(String... formats) {
        StringBuilder value = new StringBuilder(StringUtils.format(PoseidonProvideConstant.SQL_APPEND, formats));
    ...
    public static final String addArrayParameter(List<String> args) {
        ...
        createArray.append("}");
        return StringUtils.format(PoseidonProvideConstant.PARAMS_LIST_ADD, createArray.toString());
    }
