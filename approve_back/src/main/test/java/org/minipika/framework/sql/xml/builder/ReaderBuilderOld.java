...
//                            String addSQL = ProvideVar.sqlAppendProcess(sqlValue);
...
//                        // choose节点
//                        //
//                        if (ProvideVar.CHOOSE.equals(elementName)) {
...
//                                // if process
//                                //
//                                if (ProvideVar.IF.equals(chooseChild.getName())) {
//                                    // 获取if标签中的内容
//                                    test = chooseChild.getAttributeValue(ProvideVar.IF_TEST);
...
//                                // else process
//                                //
//                                if (ProvideVar.ELSE.equals(chooseChild.getName())) {
...
//                        // if节点
//                        //
//                        if (ProvideVar.IF.equals(elementName)) {
//                            // 获取if标签中的内容
...
//        if (chooseChildren.size() > 0 && !ProvideVar.IF.equals(_if.getName()))
